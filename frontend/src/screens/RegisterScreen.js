                    ...
                    <Row>
                        <Col>
                            ...
                            <Form.Group controlId='surname' className='my-4'>
                                ...
                                <Form.Control required type='name' placeholder='Enter your surname...'></Form.Control>
                            </Form.Group>
                        ...
                        <Col>
                            ...
                            <Form.Group controlId='phone' className='my-4'>
                                ...
                                <Form.Control required type='text' pattern="^[0-9]*$" placeholder='Enter your phone number...'></Form.Control>
                            </Form.Group>
                            ...
                            <Form.Group controlId='city' className='my-4'>
                                ...
                                <Form.Control required type='name' placeholder='Ex. London'></Form.Control>
                            </Form.Group>

                            <Form.Group controlId='address' className='my-4'>
                                <Form.Label>Address</Form.Label>
                                <Form.Control required type='text' placeholder='Ex. King Boulevard 61'></Form.Control>
                            </Form.Group>

                            <Form.Group controlId='tin' className='my-4'>
                                <Form.Label>Tax Identification Number</Form.Label>
                                <Form.Control required type='text' pattern="^[0-9]*$" placeholder='Enter your TIN...'></Form.Control>
                            </Form.Group>
                        </Col>
                    </Row>
