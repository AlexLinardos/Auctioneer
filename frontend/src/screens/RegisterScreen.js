                            ...
                            <Row>
                                <Col>
                                    <Form.Group controlId='first_name' className='my-3'>
                                        ...
                                        <Form.Control required type='name' placeholder='Enter your first name...'
                                    ...
                                    <Form.Group controlId='phone' className='my-4'>
                                        ...
                                        <Form.Control required type='text' pattern="^[0-9]*$" placeholder='Enter your phone number...'
                                ...
                                <Col>
                                    <Form.Group controlId='country' className='my-3'>
                                        ...
                                        <Form.Select aria-label='Select a country...' value={country} onChange={(e) => setCountry(e.target.value)} required>
                                    ...
                                    <Form.Group controlId='city' className='my-4'>
                                        ...
                                        <Form.Control required type='name' placeholder='Ex. London'
                                            value={city} onChange={(e) => setCity(e.target.value)}></Form.Control>
                                    </Form.Group>

                                    <Form.Group controlId='address' className='my-4'>
                                        <Form.Label>Address</Form.Label>
                                        <Form.Control required type='text' placeholder='Ex. King Boulevard 61'
                                ...
                                <Form.Group controlId='tin'>
                                    ...
                                    <Form.Control required type='text' pattern="^[0-9]*$" placeholder='Enter your TIN...'
